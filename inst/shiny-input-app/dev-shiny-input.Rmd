...
In our final app,
we're going to want to know on the Shiny side
...
* `r github_sha_link("def78c8a2f9c329f9c0b6ac2d59a3300af990183")`

This doesn't work because `getValue()` is already inside the "reactive" loop.
(I'll admit, this is very hand-wavy.)

Instead, we need to call a function outside of the context of `getValue()`.
To do this,
we'll write a small function that takes `id` 
and sends the current datetime to `${id}_reset`.
Then, call this function using `setTimeout()`.

* `r github_sha_link("bc452ebe4671621239d3f10054d01c90d1280bd2")`
...
* `r github_sha_link("8943c16e139d72d614d806c271868e78224da59d")`
...
* `r github_sha_link("f7a9343a26a1a0a021c32c15c870e76813b43e83")`
...
* `r github_sha_link("2eb08e286b79cb312a948a48db53813cb1eac0e2")`
